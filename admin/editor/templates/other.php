		...
		<div class="inner edit-popup-inner" data-popup-id="{{id}}">
			...
			<div class="ep-options-wrapper">
				<div class="regular-options">
					...
					<ul class="actions">
						<li><a class="editor-action duplicate mep-icon" data-action-type="duplicate" data-action="{{mode}}" data-id="{{id}}"><!-- Duplicate --></a><div class="tooltip tooltip-duplicate">Duplicate</div></li>
						<li><a class="editor-action delete mep-icon" data-layout-type="{{mode}}" data-action-type="popup" data-action="delete" data-id="{{id}}"><!-- Delete --></a><div class="tooltip tooltip-delete">Delete</div></li>
						<?php
							if(semplice_theme('edition') == 'single') {
								echo '<li class="save-block-single admin-click-handler" data-handler="execute" data-action="studioFeatures" data-action-type="popup" data-feature="blocks"><a class="save-block mep-icon"><!-- Save Block --></a><div class="tooltip tooltip-save">Save as block</div></li>';
							} else {
								echo '<li data-is-masterblock="{{masterBlock}}"><a class="save-block mep-icon editor-action" data-action-type="popup" data-action="saveBlock" data-content-id="{{sectionId}}" data-masterblock-id="{{masterBlockId}}"><!-- Save Block --></a><div class="tooltip tooltip-save">{{blockTooltip}}</div></li>';
							}
						?>
