	...
	<div id="sml-edit-meta">
		<div class="inner">
			...
			<div class="sml-meta-footer">
				<a class="admin-click-handler cancel" data-handler="execute" data-action-type="mediaLibrary" data-action="closeMeta">Cancel</a><a class="admin-click-handler confirm semplice-button" data-handler="execute" data-action-type="mediaLibrary" data-action="saveMeta" data-attachment-id="{{id}}">Save</a>
			</div>
		</div>
	</div>
</script>