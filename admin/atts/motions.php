...
$motions = array(
	...
	'options' => array(
		...
		'preview' => array(
			...
			'help'			=> 'This Preview will only show the animation itself, not the triggering event. To test with your event trigger (such as OnScroll), save your animation and preview on the front end.',
		...
		'event' => array(
			...
			'data-handler'	=> 'motion',
			'default'		=> 'on_load',
			'help'			=> 'Choose the event that starts your animation::<br /><br /><b>On Load:</b><br />Once your content is visible in the browser viewport, the animation starts.<br /><br /><b>On Scroll</b><br />Scrolling your page triggers the animation.<br /><br /><b>On Click:</b><br /> Clicking your element triggers the animation.<br /><br /><b>On Mouseover:</b><br />Mousing over your element triggers the animation.',
		...
		'delay' => array(
			...
			'min'			=> 0,
			'max'			=> 50000,
			'help'			=> 'The delay is not reflected in the preview.',
			'class' 		=> 'editor-listen',
			'data-handler'	=> 'motion',
