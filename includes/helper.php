...
function semplice_module_placeholder($module, $description, $has_upload, $is_editor) {
	...
	if($module == 'instagram' && true === $is_editor) {
		$instagram_connect = '<div class="mp-connect"><a href="https://instagram.com/oauth/authorize/?client_id=944a6351b93041c5a62a6e88d7acaed6&redirect_uri=http://redirect.semplicelabs.com/?uri=' . admin_url('admin.php?page=semplice-admin-instagram-auth') . '&response_type=token"  class="oauth-connect semplice-button green-button" target="_blank">Connect Instagram</a></div>';
	}
...
function semplice_get_module_svgs() {
	...
	// modules
	$modules = array('paragraph', 'text', 'image', 'gallery', 'video', 'spacer', 'button', 'oembed', 'portfoliogrid', 'advancedportfoliogrid', 'code', 'share', 'dribbble', 'instagram', 'gallerygrid', 'mailchimp', 'beforeafter');
